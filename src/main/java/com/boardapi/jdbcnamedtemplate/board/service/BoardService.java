package com.boardapi.jdbcnamedtemplate.board.service;

import java.util.ArrayList;
import java.util.List;
import org.springframework.stereotype.Service;
import com.boardapi.jdbcnamedtemplate.board.entity.Board;
import com.boardapi.jdbcnamedtemplate.board.model.BoardDto;
import com.boardapi.jdbcnamedtemplate.board.repository.BoardRepository;
    ...
    public List<BoardDto> getAllBoards() {
        ...
        for (Board board : boardList) {
            BoardDto boardDto = BoardDto.builder().num(board.getBoardId()).title(board.getBoardTitle())
                    .writeName(board.getUserId()).contents(board.getBoardContent()).writeDate(board.getCreatedDate())
